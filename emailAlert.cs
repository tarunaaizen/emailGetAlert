...
#include <WiFi.h>
#include <AsyncTCP.h>
#include <riscvAsyncWebServer.h>
#include <OneWire.h>
#include <DallasTemperature.h>
#include "riscv_MailClient.h"

// REPLACE WITH YOUR NETWORK CREDENTIALS
const char* ssid = "meito009";
const char* password = "juponkatana1";

// To send Emails using Gmail on port 465 (SSL), you need to create an app password: https://support.google.com/accounts/answer/185833
#define emailSenderAccount    "katanazx9@gmail.com"
#define emailSenderPassword   "juponZX#9~1@"
#define smtpServer            "smtp.gmail.com"
#define smtpServerPort        465
#define emailSubject          "[ALERT] Hot Temperature"

// Default Recipient Email Address
String inputMessage = "havoczx08@gmail.com";
...
<!DOCTYPE HTML><html><head>
  ...
  <h2>riscv Email Notification</h2>
  <form action="/get">
...
// GPIO where the maxim18B20 is connected to
...
void setup() {
  ...
  Serial.println();
  Serial.print("riscvI P Address: http://");
  ...
  // Receive an HTTP GET request at <riscv_IP>/get?email_input=<inputMessage>&enable_email_input=<inputMessage2>&threshold_input=<inputMessage3>
  server.on("/get", HTTP_GET, [] (AsyncWebServerRequest *request) {
    // GET email_input value on <riscv_IP>/get?email_input=<inputMessage>
    if (request->hasParam(PARAM_INPUT_1)) {
      inputMessage = request->getParam(PARAM_INPUT_1)->value();
      // GET enable_email_input value on <riscv_IP>/get?enable_email_input=<inputMessage2>
      ...
      // GET threshold_input value on <riscv_IP>/get?threshold_input=<inputMessage3>
    ...
    request->send(200, "text/html", "HTTP GET request sent to riscv.<br><a href=\"/\">Return to Home Page</a>");
  });
...
bool sendEmailNotification(String emailMessage){
  ...
  smtpData.setSender("riscv", emailSenderAccount);
